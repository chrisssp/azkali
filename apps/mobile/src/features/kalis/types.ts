...
export interface RedeemedKaliCardProps {
  item: RedeemedKali;
}
...
export type KaliCategory = 'shopping' | 'cashback' | 'transfer' | 'discount';

export interface Kali {
  id: string;
  title: string;
  description: string;
...
export interface KaliCardProps {
  reward: Kali;
