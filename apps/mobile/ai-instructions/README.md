...
Esta carpeta contiene documentación especializada diseñada para **nutrir agentes de IA** con conocimientos específicos sobre las arquitecturas, patrones, y herramientas utilizadas en el proyecto Azkali Mobile.
...
2. **Sigue los patrones** y convenciones especificados
...
├── architecture-patterns.md          # 🔜 Próximamente
├── state-management-zustand.md       # 🔜 Próximamente
├── navigation-expo-router.md         # 🔜 Próximamente
├── api-integration-supabase.md       # 🔜 Próximamente
├── authentication-flow.md            # 🔜 Próximamente
├── testing-strategy.md               # 🔜 Próximamente
